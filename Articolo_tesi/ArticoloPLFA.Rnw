...
<<FigRapportiTILL, fig=TRUE,  width=4.8, height=4.8, echo=FALSE, results = tex >>=
...
<<label=printBoxplotCore, fig=TRUE, echo=FALSE, width=4.8, height=4.8 >>=
plot(1:10)
@
